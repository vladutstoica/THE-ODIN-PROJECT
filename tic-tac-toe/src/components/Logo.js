export default function Logo() {
    return (
        <div className={"flex content-between items-center gap-2"}>
            <svg className={"w-12 h-auto"} width="109" height="109" viewBox="0 0 109 109" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className={"w-12 h-auto"} width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
