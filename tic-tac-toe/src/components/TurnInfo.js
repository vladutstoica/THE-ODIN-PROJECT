export default function TurnInfo() {
    return (
        <button
            className={"flex justify-center items-center gap-2 bg-custom-button text-custom-3 shadow-[0_8px_rgba(0,0,0,0.2)] rounded-lg active:translate-y-2 active:shadow-none font-bold"}>
            <svg className={"w-4 h-auto"} width="109" height="109" viewBox="0 0 109 109" fill="none"
                ...
                <rect x="0.572552" y="17.6777" width="25" height="128.048" rx="10"
                      transform="rotate(-45 0.572552 17.6777)" fill="#30C4BE"/>
            </svg>
            <svg className={"w-4 h-auto"} width="100" height="100" viewBox="0 0 100 100" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
